...
public class httpClientUtil2 {  
    ...
    public httpClientUtil2() {
    	...
    	this.requestConfig = RequestConfig.custom().setConnectTimeout(120000).setSocketTimeout(60000)  
    ...
    public static void main(String[] args) {
		...
		url = fromObject.getJSONObject(0).get("LOGIN_URL").toString();
		LOG.info("url:"+url);
		url="http://www.globalinterpark.com/main/categoryList?dispNo=01011&shopNo=0000100000&subDepth=Y&prdTp=002";
		post = t.get(url);
		LOG.info("---{}",post);
    ...
    public void printCookies() {  
    	this.cookieStore = this.context.getCookieStore();  
